...
// Difference between 81 and 82
// If array is declared in memory as malloc, then arr[6] can be referenced even if int *arr = (int *)malloc(sizeof(int) * 2) is used
// If array is declared as arr[H], then arr[H+1] cannot be referenced, it will lead to abort trap
